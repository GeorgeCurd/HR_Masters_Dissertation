...
def build_autoencoder_model(hp):
    hp_dropout1 = hp.Float('dropout1', min_value=0.0, max_value=1, step=0.1)
    ...
    hp_dropout2 = hp.Float('dropout2', min_value=0.0, max_value=1, step=0.1)
    ...
    hp_dropout3 = hp.Float('dropout2', min_value=0.0, max_value=1, step=0.1)
    ...
    hp_dropout4 = hp.Float('dropout2', min_value=0.0, max_value=1, step=0.1)
...
results = tuner.search(X_train_norm, X_train_norm, validation_data=(X_test_norm, X_test_norm))
...
history = model.fit(X_train_norm, X_train_norm, epochs=200, validation_data=(X_test_norm, X_test_norm))
